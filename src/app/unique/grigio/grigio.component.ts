...
@Component({
  selector: 'app-grigio',
  templateUrl: './grigio.component.html',
  styleUrls: ['./grigio.component.css']
})
export class GrigioComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentUniquePage = this.LanguagesService.uniqueTitle5;
  }
