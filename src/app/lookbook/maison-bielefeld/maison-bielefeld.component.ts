...
@Component({
  selector: 'app-maison-bielefeld',
  templateUrl: './maison-bielefeld.component.html',
  styleUrls: ['./maison-bielefeld.component.css']
})
export class MaisonBielefeldComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentLookbookPage = this.LanguagesService.lookbookTitle19;
  }
