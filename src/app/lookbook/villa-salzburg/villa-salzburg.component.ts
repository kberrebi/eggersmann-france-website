...
@Component({
  selector: 'app-villa-salzburg',
  templateUrl: './villa-salzburg.component.html',
  styleUrls: ['./villa-salzburg.component.css']
})
export class VillaSalzburgComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentLookbookPage = this.LanguagesService.lookbookTitle3;
  }
