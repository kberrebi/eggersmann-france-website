...
@Component({
  selector: 'app-auvent-berlin',
  templateUrl: './auvent-berlin.component.html',
  styleUrls: ['./auvent-berlin.component.css']
})
export class AuventBerlinComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentLookbookPage = this.LanguagesService.lookbookTitle8;
  }
