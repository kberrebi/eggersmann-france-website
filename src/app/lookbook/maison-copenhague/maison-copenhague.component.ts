...
@Component({
  selector: 'app-maison-copenhague',
  templateUrl: './maison-copenhague.component.html',
  styleUrls: ['./maison-copenhague.component.css']
})
export class MaisonCopenhagueComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentLookbookPage = this.LanguagesService.lookbookTitle26;
  }
