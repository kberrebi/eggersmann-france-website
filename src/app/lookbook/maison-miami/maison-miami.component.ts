...
@Component({
  selector: 'app-maison-miami',
  templateUrl: './maison-miami.component.html',
  styleUrls: ['./maison-miami.component.css']
})
export class MaisonMiamiComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentLookbookPage = this.LanguagesService.lookbookTitle13;
  }
