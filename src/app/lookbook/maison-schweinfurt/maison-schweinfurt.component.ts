...
@Component({
  selector: 'app-maison-schweinfurt',
  templateUrl: './maison-schweinfurt.component.html',
  styleUrls: ['./maison-schweinfurt.component.css']
})
export class MaisonSchweinfurtComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentLookbookPage = this.LanguagesService.lookbookTitle6;
  }
