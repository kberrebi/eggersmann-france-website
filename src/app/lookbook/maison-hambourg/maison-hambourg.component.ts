...
@Component({
  selector: 'app-maison-hambourg',
  templateUrl: './maison-hambourg.component.html',
  styleUrls: ['./maison-hambourg.component.css']
})
export class MaisonHambourgComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentLookbookPage = this.LanguagesService.lookbookTitle12;
  }
