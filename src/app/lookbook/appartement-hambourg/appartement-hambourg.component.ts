...
@Component({
  selector: 'app-appartement-hambourg',
  templateUrl: './appartement-hambourg.component.html',
  styleUrls: ['./appartement-hambourg.component.css']
})
export class AppartementHambourgComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentLookbookPage = this.LanguagesService.lookbookTitle23;
  }
