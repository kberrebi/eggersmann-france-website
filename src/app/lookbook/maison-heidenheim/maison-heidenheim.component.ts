...
@Component({
  selector: 'app-maison-heidenheim',
  templateUrl: './maison-heidenheim.component.html',
  styleUrls: ['./maison-heidenheim.component.css']
})
export class MaisonHeidenheimComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentLookbookPage = this.LanguagesService.lookbookTitle5;
  }
