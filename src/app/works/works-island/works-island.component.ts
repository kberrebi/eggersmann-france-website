...
@Component({
  selector: 'app-works-island',
  templateUrl: './works-island.component.html',
  styleUrls: ['./works-island.component.css']
})
export class WorksIslandComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentWorksPage = this.LanguagesService.worksTitle4;
  }
