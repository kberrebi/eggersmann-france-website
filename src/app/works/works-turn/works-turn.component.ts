...
@Component({
  selector: 'app-works-turn',
  templateUrl: './works-turn.component.html',
  styleUrls: ['./works-turn.component.css']
})
export class WorksTurnComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentWorksPage = this.LanguagesService.worksTitle3;
  }
