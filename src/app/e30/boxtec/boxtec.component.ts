...
@Component({
  selector: 'app-boxtec',
  templateUrl: './boxtec.component.html',
  styleUrls: ['./boxtec.component.css']
})
export class BoxtecComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentE30Page = this.LanguagesService.e30AccessoriesTitle2;
  }
