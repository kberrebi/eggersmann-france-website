...
@Component({
  selector: 'app-aluminum-niche-system',
  templateUrl: './aluminum-niche-system.component.html',
  styleUrls: ['./aluminum-niche-system.component.css']
})
export class AluminumNicheSystemComponent implements OnInit {
  ...
  constructor(public navigationService: NavigationService, private router: Router, public LanguagesService: LanguagesService) {
    this.navigationService.currentE30Page = this.LanguagesService.e30AccessoriesTitle1;
  }
